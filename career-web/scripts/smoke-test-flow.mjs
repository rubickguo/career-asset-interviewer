...
async function main() {
  ...
  assertNotIncludes(appSource, ["现在可以生成简历预览", "重新生成预览和 PDF", "重新生成策略", "进入第三轮确认", "先确认缺口", "把模糊的地方说清楚", "还差几条简历证据", "可选：分析 JD", "gapSummary", "onRenderResume={() => goTo(\"resume\")}"], "resume page copy");
