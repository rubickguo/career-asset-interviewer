...
HiJob 从中国求职市场的实际语境出发，第一版重点覆盖互联网、AI、游戏相关的产品、运营/增长、技术建设者和相邻管理岗位。它面对的不是抽象的“全球简历模板”，而是中文简历和 JD、中英文职能混用、岗位边界重叠、非线性职业经历、内部项目难以外部化、公开结果数据不足等具体问题。

但它最终想帮助的，不只是“拿到一份工作”。第一产物应该是用户对自己的长期理解：反复被证明的能力、真正喜欢和排斥的工作、现实约束、身份选择，以及想成为怎样的人。简历、JD 策略、面试故事和个人网站，只是这套理解在不同场景下的表达。

因此，`career-assets/` 在非求职期也应该持续有用，可用于职业选择、内部转岗、学习优先级、自我介绍、个人表达和长期复盘。
